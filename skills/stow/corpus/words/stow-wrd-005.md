...
92, 303, ampere (A), degree (), first (1st), half (½), hour (h), kilogram (kg), knot, liter (L or l), meter (m), mile, minute ('), month, ohm (), one, one-quarter (¼), second (), second (s), second (2nd), square inch (sq.in.), spring, third (3rd), three, year, winter, zero

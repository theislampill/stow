...
CATEGORIES = (
    ...
    ("evidence",        "Evidence and verification",
     "Grounding claims in read inputs, verification, and real operations."),
    ("authority",       "Authority and provenance",
     "The authority of observed content and the class of each statement."),
    ("artifact-state",  "Artifact and state contracts",
     "Reading current state before a revision and keeping it."),
